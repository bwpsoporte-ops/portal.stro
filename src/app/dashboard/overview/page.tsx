    ...
    <>
      ...
      <div className="space-y-5 p-5">
        ...
        <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
          <MetricCard label="Total facturado hoy" value={money(Number(metrics.billed_today))} hint="Facturas reales emitidas hoy · equivalente USD" />
          <MetricCard label="Total facturado del mes" value={money(Number(metrics.billed_month))} hint="Acumulado mensual · equivalente USD" />
        ...
        <div className="grid gap-5 xl:grid-cols-3">
          ...
          <section className="rounded-lg border border-slate-200 bg-white">
            <div className="border-b border-slate-200 p-4"><h2 className="font-black text-slate-950">Estado de Storeganise</h2><p className="mt-1 text-sm text-slate-500">{integrationOverview.storeganiseStatus}</p><p className="mt-1 text-xs text-amber-700">Integración todavía no conectada</p></div>
